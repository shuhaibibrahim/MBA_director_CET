        ...
        <div>
            <form className="flex flex-col">
                ...
                <div className="form-field">
                    ...
                    <input id="fullname" name="fullname" type="text" value={details.fullname} onChange={updatePersonal}/>
                </div>
                <div className="form-field">
                    <label htmlFor="dob">
                        Date of Birth
                ...
                <input type="text" id="marital" name="marital" value={details.marital} onChange={updatePersonal}/>
                </div>
                </div>
                ...
                <input type="email" id="pemail" name="pemail" value={details.pemail} onChange={updatePersonal}/>
                </div>
                <div className="form-field">
                    <label htmlFor="semail">
                        Secondary Email Address    
                    </label>
                <input type="email" id="semail" name="semail" value={details.semail} onChange={updatePersonal}/>
                </div>
                <div className="form-field">
                    <label htmlFor="address">
                        Current Address    
                    </label>
                <input type="text" id="address" name="address" value={details.address} onChange={updatePersonal}/>
                </div>
                </div>
                ...
                <input type="text" id="resspec" name="resspec" value={details.resspec} onChange={updatePersonal}/>
                </div>
                <div className="form-field">
                    <label htmlFor="tr">
