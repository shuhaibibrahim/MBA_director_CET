        ...
        <div>
            <form>
                ...
                <div className="transition duration-500 ease-in-out">
                    <div>
                        <label htmlFor="noPatents">No. of international /Indian patents issued:</label>
                    ...
                    <div className="grid gap-3 mb-7">
                        ...
                        <div className="form-field">
                            <label htmlFor="organizationAssignedTo">Organization assigned to</label>
                            <input
                                type="text"
                ...
                <div className="transition duration-500 ease-in-out">
                    <div>
                        <label htmlFor="noFiledPatents">No. of international /Indian patents filed:</label>
                        <input
                            className="w-20 ml-5"
                            type="text"
                            id="noFiledPatents"
