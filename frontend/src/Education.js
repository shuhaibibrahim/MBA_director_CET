        ...
        <div>
            <form className="flex flex-col">
                ...
                <div className="grid grid-cols-2 gap-y-3 gap-x-5">
                    ...
                    <div className="form-field">
                        <label htmlFor="title">Title of Thesis</label>
                        <input
                            type="text"
                            id="title"
                            name="title"
                    ...
                    <div className="form-field">
                        <label htmlFor="affiliation">Affiliation of Supervisor</label>
                        <input
                            type="text"
                            id="affiliation"
                            name="affiliation"
                    ...
                    <div className="form-field">
                        <label htmlFor="submitdate">Date of Ph.D Thesis (Submitted for Evaluation)</label>
                        <input
                            type="date"
                            id="submitdate"
                            name="submitdate"
                    ...
                    <div className="form-field">
                        <label htmlFor="defenddate">Date of Ph.D Thesis (Defended Successfully)</label>
                        <input
                            type="date"
                            id="defenddate"
                            name="defenddate"
                ...
                <div className="grid grid-cols-2 gap-x-5 gap-y-3">
                    ...
                    <div className="form-field">
                        <label htmlFor="division">Division/Awarded</label>
                        <input
                            type="text"
                            id="division"
                            name="division"
                    ...
                    <div className="form-field">
                        <label htmlFor="system">System of Awarding Marks</label>
                        <input
                            type="text"
                            id="system"
                            name="system"
