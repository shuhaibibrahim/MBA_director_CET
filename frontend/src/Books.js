  ...
  return (
    <div>
      <form className="flex flex-col">
        ...
        <h2 className="my-3">
          Provide details of up to 4 most significant & recent papers published
          as a book chapter
        </h2>
        <div className="transition duration-500 ease-in-out">
          {renderPublications1}
        ...
        <h2 className="font-bold my-3">
          C. Publications (international journals)
        </h2>
        <label htmlFor="noPublished2">
          No.of papers published or accepted for publication in international
          journals:
          <input
            className="ml-2"
            type="text"
        ...
        <h2 className="font-bold my-3">
          E. Publications (in peer-reviewed conferences held abroad)
        </h2>
        <label htmlFor="noPublished4">
          No.of papers published or accepted for publication in refereed
        ...
        <h2 className="font-bold my-3">
          F. Publications/Presentation (in peer-reviewed conferences held in
          India)
        </h2>
        <label htmlFor="noPublished5">
          No.of papers published or accepted for publication or presented in
