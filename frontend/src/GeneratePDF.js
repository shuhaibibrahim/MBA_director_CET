...
function GeneratePDF({ details, setformno, scrollTop, user }) {
    ...
    return (
        <>
            ...
            <div className="w-9/12 mx-auto mt-6 mb-10 bg-white shadow-md rounded-xl">
                <PDFExport paperSize="A4" scale={0.6} margin="2cm" ref={pdfExportComponent}>
                    ...
                    <dl className="review-section">
                        ...
                        <p>
                            <dt>No. of Ph.D. thesis supervised singly (defended successfully)</dt>
                            <dd>{details.singlySupervisedThesis}</dd>
                        </p>
                        <p>
                            <dt>No. of Ph.D. thesis supervised jointly (defended successfully)</dt>
                        ...
                        <div className="divide-y-2 divide-dashed divide-red-500">
                            {details.thesis.map((item) => (
                                <div key={item.id} className="flex items-center mb-2 justify-between">
                                    <div className="flex flex-col">
                                        <div>
                                            <dt>Student Name</dt>: {item.studentname}
                                        </div>
                                        <div>
                                            <dt>Thesis Title</dt>: {item.title}
                                        </div>
                                        <div>
                                            <dt>Supervisor</dt>: {item.supervisor}
                                        </div>
                                        <div>
                                            <dt>Year Successfully Defended</dt>:{item.year}
                                        </div>
                                    </div>
                                </div>
                            ))}
                        ...
                        <h4>M.Tech, MPhil, MTech, MBA thesis supervised (completed only)</h4>
                        <p>
                        ...
                        <h4>Details of sponsored R&D projects (completed, and as Principal Investigator)</h4>
                        <p>
                            <dt>
                        ...
                        <div className="divide-y-2 divide-dashed divide-red-500">
                            {details.projects1.map((item) => (
                                <div key={item.id} className="flex items-center mb-2 justify-between">
                                    <div className="flex flex-col">
                                        <div>
                                            <dt>Title</dt> : {item.title}
                                        </div>
                                        <div>
                                            <dt>Sponsor</dt> : {item.sponsor}
                                        </div>
                                        <div>
                                            <dt>Duration(years)</dt> : {item.years}
                                        </div>
                                        <div>
                                            <dt>Grant Amount in Rs.</dt> : {item.amount}
                                        </div>
                                    </div>
                                </div>
                            ))}
                        ...
                        <h4>Details of sponsored R&D projects (in-progress and as Principal Investigator)</h4>
                        <p>
                            <dt>
                        ...
                        <h4>Details of sponsored R&D projects (Completed and as Co-Principal Investigator)</h4>
                        <p>
                            <dt>
                        ...
                        <h4>Details of sponsored R&D projects (in-progress and as Co-Principal Investigator)</h4>
                        <p>
                            <dt>
                        ...
                        <h4>Details of industry-or government-sponsored consulting assignments completed</h4>
                        <p>
                            <dt>
                    ...
                    <dl className="review-section">
                        ...
                        <div className="divide-y-2 divide-dashed divide-red-500">
                            {details.books.map((item) => (
                                <div key={item.id} className="flex items-center mb-2 justify-between">
                                    <div className="flex flex-col">
                                        <div>
                                            <dt>Co-authors</dt> : {item.coauthors}
                                        </div>
                                        <div>
                                            <dt>Title</dt> : {item.title}
                                        </div>
                                        <div>
                                            <dt>Edition</dt> : {item.edition}
                                        </div>
                                        <div>
                                            <dt>Edition</dt> : {item.publisher}
                                        </div>
                                        <div>
                                            <dt>Date published</dt> : {item.date}
                                        </div>
                                    </div>
                                </div>
                            ))}
                            ...
                            {details.publications2.map((item) => (
                                <div key={item.id} className="flex items-center mb-2 justify-between">
                                    <div className="flex flex-col">
                                        ...
                                        <div>
                                            <dt>Journal Name</dt> : {item.journalname}
                                        </div>
                                        <div>
                                            <dt>Publisher</dt> : {item.publisher}
                                        </div>
                                        <div>
                                            <dt>Volume No.</dt> : {item.volumeno}
                                        </div>
                                        <div>
                                            <dt>Pages</dt> : {item.pages}
                                        </div>
                                        <div>
                                            <dt>Date published</dt> : {item.date}
                                        </div>
                                        <div>
                                            <dt>Indexed in</dt> : {item.indexedin}
                                        </div>
                                    </div>
                                </div>
                            ))}
                        ...
                        <h4>E. Publications (in peer-reviewed conferences held abroad)</h4>
                        <p>
                            <dt>
                            ...
                            {details.publications4.map((item) => (
                                <div key={item.id} className="flex items-center mb-2 justify-between">
                                    <div className="flex flex-col">
                                        ...
                                        <div>
                                            <dt>Conference Name</dt> : {item.conferencename}
                                        </div>
                                        <div>
                                            <dt>Location</dt> : {item.location}
                                        </div>
                                        <div>
                                            <dt>Pages</dt> : {item.pages}
                                        </div>
                                        <div>
                                            <dt>Month</dt> : {item.month}
                                        </div>
                                        <div>
                                            <dt>Year Held</dt> : {item.yearheld}
                                        </div>
                                    </div>
                                </div>
                            ))}
                        ...
                        <h4>F. Publications/Presentation (in peer-reviewed conferences held in India)</h4>
                        <p>
                            <dt>
                        ...
                        <div className="divide-y-2 divide-dashed divide-red-500">
                            {details.patents.map((item) => (
                                <div key={item.id} className="flex items-center mb-2 justify-between">
                                    <div className="flex flex-col">
                                        <div>
                                            <dt>Patent Title</dt> : {item.title}
                                        </div>
                                        <div>
                                            <dt>Co Inventors</dt> : {item.coInventors}
                                        </div>
                                        <div>
                                            <dt>Patent Authority</dt> : {item.patentAuthority}
                                        </div>
                                        <div>
                                            <dt>Patent Number</dt> : {item.patentNumber}
                                        </div>
                                        <div>
                                            <dt>Date Published</dt> : {item.datePublished}
                                        </div>
                                        <div>
                                            <dt>Organization Assigned To</dt> : {item.organizationAssignedTo}
                                        </div>
                                    </div>
                                </div>
                            ))}
                            ...
                            <div className="divide-y-2 divide-dashed divide-red-500">
                                {details.referee.map((item) => (
                                    <div key={item.id} className="flex items-center mb-2 justify-between">
                                        <div className="flex flex-col">
                                            <div>
                                                <dt>Name</dt>: {item.name}
                                            </div>
                                            <div>
                                                <dt>Designation</dt>: {item.designation}
                                            </div>
                                            <div>
                                                <dt>Organization</dt>: {item.organization}
                                            </div>
                                            <div>
                                                <dt>Email Address</dt>: {item.email}
                                            </div>
                                            <div>
                                                <dt>Postal Address</dt>: {item.postaladdress}
                                            </div>
                                            <div>
                                                <dt>Phone Number</dt>: {item.phoneno}
                                            </div>
                                        </div>
                                    </div>
                                ))}
